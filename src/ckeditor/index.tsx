...
export default function Editor() {
	...
	function refreshDisplayMode() {
		...
		const sidebarElement:any = sidebarElementRef.current;
	...
	function checkPendingActions( domEvt:any ) {
		if ( editor ) {
			return;
		}
	...
	function renderEditor() {
		return (
			<div className="row row-editor">
				...
				{ isLayoutReady && (
					<CKEditor
						...
						config={ {
							...
							sidebar: {
								container: sidebarElementRef.current as HTMLElement
							},
				...
				<div ref={ sidebarElementRef as React.LegacyRef<HTMLDivElement> } className="sidebar"></div>
			</div>
		);
	}
            ...
            <main>
                ...
                <div className="centered">
                    ...
                    <div className="row row-info">
                        ...
                        <button className="remove-license-key" onClick={ resetLicenseKey }>Reset license key</button>
                    </div>
                </div>
            </main>
        </div>
...
class TrackChangesIntegration {
	...
	init() {
		...
		trackChangesPlugin.adapter = {
			getSuggestion: (suggestionId: any) => {
			...
			updateSuggestion: ( id: any, suggestionData: any ) => {
